...
public class ForgeMod {
                    ...
                    .canHydrate(true))
            {
                ...
                public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
                    consumer.accept(new IClientFluidTypeExtensions() {
                        private static final Identifier UNDERWATER_LOCATION = Identifier.m_438827_("textures/misc/underwater.png");
                        private static final Identifier WATER_STILL = Identifier.m_438827_("block/water_still");
                        private static final Identifier WATER_FLOW = Identifier.m_438827_("block/water_flow");
                        private static final Identifier WATER_OVERLAY = Identifier.m_438827_("block/water_overlay");
    ...
    public static final RegistryObject<FluidType> LAVA_TYPE = VANILLA_FLUID_TYPES.register("lava", () ->
                    ...
                    .temperature(1300))
            {
                ...
                public double motionScale(Entity entity) {
                    return entity.m_9236_().m_438899_().m_440693_(EnvironmentAttributes.f_437069_) ? 0.007D : 0.0023333333333333335D;
                }
                ...
                public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
                    consumer.accept(new IClientFluidTypeExtensions() {
                        private static final Identifier LAVA_STILL = Identifier.m_438827_("block/lava_still");
                        private static final Identifier LAVA_FLOW = Identifier.m_438827_("block/lava_flow");
    ...
    public static final RegistryObject<SoundEvent> BUCKET_EMPTY_MILK = RegistryObject.create(Identifier.m_438827_("item.bucket.empty_milk"), ForgeRegistries.SOUND_EVENTS);
    public static final RegistryObject<SoundEvent> BUCKET_FILL_MILK = RegistryObject.create(Identifier.m_438827_("item.bucket.fill_milk"), ForgeRegistries.SOUND_EVENTS);
    public static final RegistryObject<FluidType> MILK_TYPE = RegistryObject.createOptional(Identifier.m_438827_("milk"), ForgeRegistries.Keys.FLUID_TYPES.m_447358_(), "minecraft");
    public static final RegistryObject<Fluid> MILK = RegistryObject.create(Identifier.m_438827_("milk"), ForgeRegistries.FLUIDS);
    public static final RegistryObject<Fluid> FLOWING_MILK = RegistryObject.create(Identifier.m_438827_("flowing_milk"), ForgeRegistries.FLUIDS);
    ...
    public ForgeMod(FMLJavaModLoadingContext context) {
        ...
        addAlias(ForgeRegistries.ATTRIBUTES, Identifier.m_445280_("forge", "reach_distance"), Identifier.m_445280_("forge", "block_reach"));
        addAlias(ForgeRegistries.ATTRIBUTES, Identifier.m_445280_("forge", "attack_range"), Identifier.m_445280_("forge", "entity_reach"));
    }
    ...
    private static void gatherData(GatherDataEvent event) {
        ...
        gen.addProvider(true, new PackMetadataGenerator(packOutput)
            .m_247300_(PackMetadataSection.f_411753_, new PackMetadataSection(
                Component.m_237115_("pack.forge.description"),
                DetectedVersion.f_132476_.m_403307_(PackType.SERVER_DATA).m_419388_()
            ))
        );
    ...
    private static void registerFluids(RegisterEvent event) {
        if (enableMilkFluid) {
            ...
            event.register(ForgeRegistries.Keys.FLUID_TYPES, helper -> helper.register(MILK_TYPE.getId(), new FluidType(
                ...
                public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
                    consumer.accept(new IClientFluidTypeExtensions() {
                        private static final Identifier MILK_STILL = Identifier.m_445280_("forge", "block/milk_still");
                        private static final Identifier MILK_FLOW = Identifier.m_445280_("forge", "block/milk_flowing");
    ...
    private static void registerVanillaDisplayContexts(RegisterEvent event) {
        if (event.getRegistryKey().equals(ForgeRegistries.Keys.DISPLAY_CONTEXTS)) {
            ...
            Arrays.stream(ItemDisplayContext.values())
                ...
                .forEach(ctx -> forgeRegistry.register(ctx.m_269462_(), Identifier.m_445280_("minecraft", ctx.m_7912_()), ctx));
        }
    }

    public static final PermissionNode<Boolean> USE_SELECTORS_PERMISSION = new PermissionNode<>("forge", "use_entity_selectors",
            PermissionTypes.BOOLEAN, (player, uuid, contexts) -> player != null && Commands.f_165684_.m_438875_(player.m_441099_()));
