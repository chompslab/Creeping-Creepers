/*
 * ============================================================================
 * WitherCreeperModel.java
 * ============================================================================
 *
 * WHAT THIS FILE DOES:
 * Defines the 3D model for the Wither Creeper entity.
 ...
 * - Animation logic (walking, swelling)
 *
 * MODEL STRUCTURE:
...
import com.creepingcreepers.client.renderer.WitherCreeperRenderState;
...
/**
 * Model class for the Wither Creeper.
 *
 * Based on vanilla Creeper model with the same bone structure.
 */
public class WitherCreeperModel extends EntityModel<WitherCreeperRenderState> {

    /**
     * Layer location for model registration.
     */
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(Identifier.fromNamespaceAndPath(CreepingCreepersMod.MOD_ID, "wither_creeper"), "main");
     ...
     */
    public WitherCreeperModel(ModelPart root) {
        super(root);
     ...
     */
    @Override
    public void setupAnim(WitherCreeperRenderState state) {
        ...
        // Animate legs for walking (vanilla creeper behavior)
